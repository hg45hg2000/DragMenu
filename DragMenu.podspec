#
#  Be sure to run `pod spec lint DragMenu.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/hg45hg2000/DragMenu.git", :tag => "#{s.version}" }
